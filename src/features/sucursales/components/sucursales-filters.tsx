...
export const SucursalesFilters = ({
  ...
  const { clientes: empresasOptions, loading } = useCatalogOptions();
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center gap-3 mb-6">
      ...
      >
        <SelectTrigger className="w-full sm:w-auto min-w-[200px] max-w-[280px] bg-white border-gray-200 h-10 text-sm">
          <SelectValue
      ...
      >
        <SelectTrigger className="w-full sm:w-[160px] bg-white border-gray-200 h-10 text-sm">
          <SelectValue>
            {selectedEstado === "true"
              ? "Estado: Activo"
